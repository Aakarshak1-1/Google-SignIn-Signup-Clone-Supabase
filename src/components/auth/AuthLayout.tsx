...
export const AuthLayout = ({ children, title, subtitle }: AuthLayoutProps) => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#202124] p-4">
      <div className="w-full max-w-[450px] p-12 rounded-2xl bg-[#202124] border border-gray-700">
        <div className="flex flex-col items-center mb-8">
          ...
          {subtitle && (
            <p className="text-base text-gray-400 text-center">{subtitle}</p>
          )}
        </div>
        ...
        <div className="mt-8 flex flex-col space-y-4">
          <div className="flex justify-between text-sm">
            <select className="bg-transparent text-gray-400 border-none focus:outline-none cursor-pointer appearance-none">
